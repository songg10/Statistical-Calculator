...
package ['python3', 'python3-pip', 'python3-dev', 'python3-flask']  # Python
...
#Python flask CORS library
execute 'pip3 install -U flask-cors' 

execute 'npm install -g react-scripts'

execute 'screen -dm flask run --host=0.0.0.0 -p 8080 &' do
  cwd project_home
  user username
